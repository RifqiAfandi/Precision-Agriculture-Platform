...
export const dailyWeatherData = [
  { day: "Sen", avgTemp: 27.2, totalRain: 12.5, maxWind: 18.2, avgAQI: 48 },
  { day: "Sel", avgTemp: 28.1, totalRain: 8.3, maxWind: 15.7, avgAQI: 52 },
  { day: "Rab", avgTemp: 26.8, totalRain: 25.2, maxWind: 22.1, avgAQI: 45 },
  { day: "Kam", avgTemp: 29.5, totalRain: 5.1, maxWind: 14.3, avgAQI: 55 },
  { day: "Jum", avgTemp: 30.2, totalRain: 2.8, maxWind: 16.8, avgAQI: 62 },
  { day: "Sab", avgTemp: 29.8, totalRain: 7.4, maxWind: 13.9, avgAQI: 58 },
  { day: "Min", avgTemp: 28.9, totalRain: 15.6, maxWind: 17.5, avgAQI: 51 },
];
...
export const weatherInsights = [
  {
    ...
    description:
      "AQI meningkat dari 45 ke 57 dalam 6 jam terakhir. Disarankan membatasi aktivitas outdoor.",
    recommendation:
      "Hindari penyemprotan pestisida hingga AQI turun di bawah 50",
    icon: "AlertTriangle",
  ...
  },
  {
    ...
    description:
      "Kelembaban udara 78% dengan angin sedang 12.3 km/h. Waktu yang baik untuk penyiraman.",
    recommendation:
      "Lakukan irigasi dalam 2 jam ke depan sebelum angin menguat",
    icon: "Droplets",
    category: "irrigation",
  },
  {
    ...
    description:
      "Suhu akan stabil di range 28-30°C dalam 24 jam ke depan dengan hujan ringan.",
