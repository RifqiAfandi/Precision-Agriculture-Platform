...
export function StationDetailPanel({ station, onExport }) {
  ...
  const statusConfig = {
    excellent: { color: "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400", label: "Sangat Baik" },
    optimal: { color: "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400", label: "Optimal" },
    good: { color: "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400", label: "Baik" },
    normal: { color: "bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400", label: "Normal" },
    moderate: { color: "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400", label: "Sedang" },
    calm: { color: "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400", label: "Tenang" },
    warning: { color: "bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-400", label: "Peringatan" },
    unhealthy: { color: "bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-400", label: "Tidak Sehat" },
  };
